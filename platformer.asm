...
PLAYERYHIGH:       .res 1
PLAYERYSPEED:      .res 1
PLAYERCANJUMP:     .res 1  ;If I get greed consider turning this into something bitmaskable, probably being wasteful asis
PLAYERISFORWARD:   .res 1
MUSICISPLAYING:    .res 1
PLAYERJUMPLEFT:    .res 1
CONTROLLERREAD1:   .res 1 ; bitmask controller
ANIMATIONFRAME:    .res 1
CURRENTSPRITE:     .res 1
CURRENTJUMP:       .res 1
SCREENX:          .res 1  ;where the camera is pointed
tempValue:         .res 1  ; to store temp values duh
background_pointer: .res 2  ; a pointer which points to the portion of the level to render
...
CheckX:
  CPY #$00
  BNE LoabyteackgroundLoop
  INX
  INC background_pointer+1
  JMP LoabyteackgroundLoop
...
INITIALIZELOOP:
  ...
  ;LDY #HIGH(superrunner_music_data) might bring back music after fixing assembler
  ;JSR FamiToneInit
...
palette:
  ...
  .byte $0F,$06,$27,$14,$0F,$02,$38,$3C,$0F,$1C,$15,$14,$0F,$02,$38,$3C

sprites:
     ;vert tile attr horiz
  .byte $80, $00, $00, $40   ;sprite 0
  .byte $80, $01, $00, $48   ;sprite 1 
  .byte $88, $10, $00, $40   ;sprite 2  
  .byte $88, $11, $00, $48   ;sprite 3


background:
  .byte $01,$01,$01,$10,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ;;row 1
  .byte $11,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ;;all sky

  .byte $11,$11,$11,$11,$10,$12,$12,$12,$00,$00,$00,$00,$00,$00,$00,$00 ;;row 1
  ...
  .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$08,$00,$00,$00,$00,$00 ;;row 1
  .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ;;all sky

  .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ;;row 1
  .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ;;all sky
  
  .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$08,$08,$00,$00,$00,$00,$00 ;;row 1
  .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ;;all sky
  ...
  .byte $00,$00,$00,$00,$00,$00,$00,$00,$08,$08,$08,$08,$08,$08,$08,$08 ;;row 1
  .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ;;all sky

  .byte $04,$04,$04,$04,$04,$04,$04,$04,$00,$00,$00,$00,$00,$00,$00,$00 ;;row 1
  .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ;;all sky
